...
const I18N = {
  en: {
    ...
    hero: { status:'Available for consulting & support', tagline:'Systems engineer. Cross-platform C++. Game engines, reverse engineering, performance-critical systems.', viewProjects:'View Projects' },
    ...
    experience: { label:'Experience', items:[
      { year:'2024–Now', title:'C++ Systems Engineer', company:'Consulting & Open Source · Remote', desc:'Android NDK cross-compilation pipelines. CMake templates with CI/CD, CPack, Gradle Managed Devices. Reverse engineering toolkits for classic games. Build engineering and cross-platform C++ consulting.', tags:['C++23','CMake','Android NDK','Reverse Engineering','SDL3'], link:null },
      ...
      { year:'2020–2025', title:'Open Source Developer', company:'github.com/e-gleba', desc:'Published 25+ repositories: game engines, reverse engineering tools, CMake build systems, and cross-platform libraries. Maintained cxx-skeleton, cmake_template, airstrike3d-tools projects.', tags:['Open Source','CMake','Game Dev','RE'], link:'https://github.com/e-gleba' }
    ]},
    ...
    contact: { label:'Contact', text:'Open to consulting, contract work, and interesting collaborations. Reach out via any channel below — I respond fastest on Telegram and Email.' },
  ...
  ru: {
    ...
    hero: { status:'Открыт для консалтинга и поддержки', tagline:'Системный инженер. Кроссплатформенный C++. Игровые движки, реверс-инжиниринг, высоконагруженные системы.', viewProjects:'Проекты' },
    ...
    experience: { label:'Опыт', items:[
      { year:'2024–сейчас', title:'C++ Systems Engineer', company:'Консалтинг и Open Source · Удалённо', desc:'Кроссплатформенные пайплайны Android NDK. CMake-шаблоны с CI/CD, CPack, Gradle Managed Devices. Инструменты реверс-инжиниринга классических игр. Консалтинг по системам сборки и кроссплатформенному C++.', tags:['C++23','CMake','Android NDK','Reverse Engineering','SDL3'], link:null },
      ...
      { year:'2020–2025', title:'Open Source Developer', company:'github.com/e-gleba', desc:'Опубликовано 25+ репозиториев: игровые движки, инструменты реверс-инжиниринга, системы сборки CMake и кроссплатформенные библиотеки. Поддержка проектов cxx-skeleton, cmake_template, airstrike3d-tools.', tags:['Open Source','CMake','Game Dev','RE'], link:'https://github.com/e-gleba' }
    ]},
    ...
    contact: { label:'Контакты', text:'Открыт для консалтинга, контрактов и интересных проектов. Пишите в любой канал — быстрее всего отвечаю в Telegram и на Email.' },
  ...
  zh: {
    ...
    hero: { status:'开放咨询与技术支持', tagline:'系统工程师。跨平台 C++。游戏引擎，逆向工程，高性能系统。', viewProjects:'查看项目' },
    ...
    experience: { label:'经历', items:[
      { year:'2024–至今', title:'C++ 系统工程师', company:'咨询与开源 · 远程', desc:'Android NDK 跨平台编译管线。CMake 模板 CI/CD、CPack、GMD。经典游戏逆向工程工具。构建工程和跨平台 C++ 咨询。', tags:['C++23','CMake','Android NDK','逆向工程','SDL3'], link:null },
      ...
      { year:'2020–2025', title:'开源开发者', company:'github.com/e-gleba', desc:'发布 25+ 个仓库：游戏引擎、逆向工程工具、CMake 构建系统和跨平台库。维护 cxx-skeleton、cmake_template、airstrike3d-tools 项目。', tags:['开源','CMake','游戏开发','逆向工程'], link:'https://github.com/e-gleba' }
    ]},
    ...
    contact: { label:'联系', text:'开放咨询、合同工作和有趣的项目。通过以下任何渠道联系——我在 Telegram 和 Email 上回复最快。' },
